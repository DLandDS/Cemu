...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    # Cemu's x64-windows-static triplet needs the plugins registered inside the
    # executable. The upstream port's default gst-full is a shared library.
    # Keep the static gst-full archive and its pkg-config dependency list.
    set(CEMU_GST_FULL_OPTIONS
        -Dgst-full=enabled
        -Dgst-full-target-type=static_library
        -Dgst-full-libraries=gstreamer-app-1.0,gstreamer-video-1.0
    )
endif()
